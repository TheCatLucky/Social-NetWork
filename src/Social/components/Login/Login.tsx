  ...
  return (
    <div>
      ...
      <p className={style.login}>
        ...
        <a href="https://social-network.samuraijs.com/" className={style.a} target="_blank" rel="noreferrer">
          сайте
        </a>
...
const LoginForm: FC<InjectedFormProps<LoginFormValuesType, LoginFormOwnPropsType> & LoginFormOwnPropsType> = (
  ...
  return (
    <form className={style.form} onSubmit={props.handleSubmit}>
      ...
      {props.captchaURL && <Field name={"captcha"} component={Input} type={"Input"} className={style.formInput} />}
      <div>
        <button>Login</button>
      </div>
    </form>
...
const ReduxLoginForm = reduxForm<LoginFormValuesType, LoginFormOwnPropsType>({ form: "login" })(LoginForm);
